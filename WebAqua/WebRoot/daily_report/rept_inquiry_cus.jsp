...
<form name="ReptInquiryForm" action="/daily_report/rept_inquiry_cus.do" method="post" onsubmit="return click_search();">
	          		<tr> 
	            		<td height="20">
												...
												<%
							                     ...
							                     %>
						                      		<tr bgcolor="<%= bgcolor %>" borderColorLight="#" onmouseover="this.className='menuover'-1" onmouseout="this.className='menuNo-1'">   
														...
														<td width="149" height="20" align="center"><a href="/daily_report/rept_download.do?rept_id=<bean:write name="rept" property="rept_id"/>" target="top"><img src="/img/btn_receive.gif" border="0"></a></td>
						                      		</tr>
												</logic:iterate>
											</logic:notEmpty>
