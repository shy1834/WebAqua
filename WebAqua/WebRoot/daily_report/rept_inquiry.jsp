...
function click_delete(rept_id) {
	document.ReptActionForm.action="/daily_report/rept_delete.do";
        ...
        <table width="820" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td><table width="820" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="490" height="32"><img src="/img/title05.gif"></td>
                  <td width="330"><jsp:include page="rept_page_map.jsp" /> 보고서 조회</td>
                </tr>
              </table></td>
          </tr>
          <tr> 
...
<form name="ReptInquiryForm" action="/daily_report/rept_inquiry.do" method="post" onsubmit="return click_search();">
          <tr> 
            <td height="20"><table width="810" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="129" height="25"></td>
				  <td width="81"><img src="/img/05_2.gif" width="81" height="17"></td>
				  <td width="105"><input type="text" name="rept_nm" size="15" value="<bean:write name="REPT_NM"/>" class="input"></td>
				  <td width="70" height="25"><div align="right"><img src="/img/img_form_name.gif" width="69" height="30"></div></td>
                  <td width="105" height="25"><input type="text" name="rept_tmpl_nm" size="15" value="<bean:write name="REPT_TMPL_NM"/>" class="input"></td>
                  <td width="50" height="25"><img src="/img/sear_29.gif" width="50" height="30"></td>
                  ...
                  <!--
                    ...
                    <img src="/img/cal.gif" width="21" height="21" border="0" style="cursor:hand" onclick="showCalendar(document.all['eventTimeFrom'])" align="absmiddle"> 
                    ~ <input name="eventTimeTo" type="text" class="input" value="<bean:write name="eventTimeTo"/>" size="12" disabled>
                    <img src="/img/cal.gif" width="21" height="21" border="0" style="cursor:hand" onclick="showLeftCalendar(document.all['eventTimeTo'])" align="absmiddle">
                  -->
                  ...
                  <td width="30" height="25"><div align="right"><input type="image" name="" src="/img/search_03.gif" border="0" onfocus="this.blur();" style="border:0"></div></td>
                </tr>
              </table></td>
          </tr>
                        ...
                        <td height="25" colspan="6" background="/img/table_bg.gif">
                          <table border="0" cellpadding="0" cellspacing="0" class="title">
                            <tr>
                              ...
                              <td width="1"><img src="/img/table_line.gif" width="1" height="25"></td>
                              ...
                              <td width="1"><img src="/img/table_line.gif" width="1" height="25"></td>
                              <td width="70" ><div align="center"><font color="#FFFFFF"><strong>삭제</strong></font></div></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
					...
					<%
                     ...
                     %>
                      <tr bgcolor="<%= bgcolor %>" borderColorLight="#" onmouseover="this.className='menuover'-1" onmouseout="this.className='menuNo-1'">   
                        <td width="70"  height="20" align="center"><bean:write name="rept" property="rownum"/></td> 
                        <td width="130"  height="20" align="center"><div style="width: 120; overflow: hidden" nowrap><bean:write name="rept" property="reg_dt"/></div></td>
                        <td width="220"   height="20" align="center"><div style="width: 220; overflow: hidden" nowrap><bean:write name="rept" property="rept_tmpl_nm"/></div></td>
						<td width="220"  height="20" align="center"><div style="width: 100; overflow: hidden" nowrap><bean:write name="rept" property="rept_nm"/></div></td>
						<td width="100"  height="20" align="center"><a href="/daily_report/rept_download.do?rept_id=<bean:write name="rept" property="rept_id"/>" target="top"><img src="/img/btn_receive.gif" border="0"></a></td>
                        <td width="70"   height="20" align="center"><img src="/img/btn_adjust.gif" width="16" height="16"  style="cursor:hand" onclick="click_delete('<bean:write name="rept" property="rept_id"/>')"></td>
                      </tr>
					</logic:iterate>
					</logic:notEmpty>
...
<form name="ReptActionForm" action="/daily_report/rept_delete.do" method="post">
